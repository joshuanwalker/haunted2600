...
playerHorizDelta          = $e7 ; left/right movement of player/eyes 0, 1, or -1 ($ff)
playerVertDelta          = $e8 ;  up/down   movement of player/eyes 0, 1, or -1 ($ff)
